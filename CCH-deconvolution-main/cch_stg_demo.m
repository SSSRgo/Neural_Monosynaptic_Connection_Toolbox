...
[ eSTG1, ~, ~, ~, dcCCH, crCCH1, cchbins ] = call_cch_stg( spkT, spkL, spkFS, binSize, halfSize, W );
...
den                             =  nspks1  * dt; 
crCCH2                           = ( cc( :, u1, u2 ) - pred ) ./ den;      	% [spk/s]

% (3) compute the STGs (Eq. 5)
t                               = cchbins * 1000;                           % [ms]
t_ROI                           = t >= roiMS( 1 ) & t <= roiMS( 2 );
g1                              = calc_stg( crCCH2, t_ROI, dt );
...
subplot( 2, 4, 3 );
plot_CCH( cchbins, crCCH2(:,1), Cbars, NaN, g1 )
subplot( 2, 4, 4 );
plot_CCH( cchbins, crCCH1(:,cidx), Cdc, NaN, eSTG1( cidx ) )
%-------------------------------------------------------------------------------------
...
[ eSTG1, ~, act, sil, dcCCH, crCCH1, cchbins ] = call_cch_stg( spkT, spkL, spkFS, binSize, halfSize, W );
